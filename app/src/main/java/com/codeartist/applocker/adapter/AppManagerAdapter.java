...
public class AppManagerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ViewHolder holder;
        if (view == null) {
            view = sInflater.inflate(R.layout.item_app_manager, null);
        ...
        if (mAppList.get(position).isLocked()) {
            holder.locker.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.locker));
        } else {
            holder.locker
                    .setImageDrawable(mContext.getResources().getDrawable(R.mipmap.lock_open));
        }
