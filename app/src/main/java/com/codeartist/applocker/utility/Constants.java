...
public class Constants {
    ...
    public static final int ACCURACY_VERY_HIGH = 150;
    public static final int ACCURACY_HIGH = 200;
    public static final int ACCURACY_LOW = 250;
    public static final int PATTERN_LOCK = 1;
    public static final int NUMBER_LOCK = 2;
